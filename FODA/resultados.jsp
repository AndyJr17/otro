...
<body>
    ...
    <section>
        <%
            ...
            String jdbcUrl = "jdbc:mysql://bubwgo9pmv93axyrafc6-mysql.services.clever-cloud.com:3306/bubwgo9pmv93axyrafc6";  // Cambia si es necesario
            String dbUser  = "uvqrunfx9foplcl6";  // Cambia con el usuario correcto
            String dbPassword = "G9gZ3Pt69OJVxUJWWCzK";  // Cambia con la contraseña correcta
