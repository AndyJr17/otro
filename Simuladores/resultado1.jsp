...
<%
    ...
    try {
        ...
        conn = DriverManager.getConnection("jdbc:mysql://bubwgo9pmv93axyrafc6-mysql.services.clever-cloud.com:3306/bubwgo9pmv93axyrafc6", "uvqrunfx9foplcl6", "G9gZ3Pt69OJVxUJWWCzK");
